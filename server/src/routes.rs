...
// TODO : implement insert_new_user in src/db.rs to ensure this method is working properly as intended.
...
//     db::insert_new_user(&mut conn, &form.username, &form.email)
//   }).await?
...
// ) -> Result<HttpResponse, Error> {
//   let user_email = email.to_string();    // originally email.to_string()
...
// NOTE : return type : -> Result<HttpResponse, Error>
// TODO : fix, partially implemented
// #[get("/rooms")]
